 ...
 This will deploy two artifacts, target/call4all.war and
 default-ds.xml.
 ...
 Now you can either deploy the target/call4all.war through the
 web-based GlassFish admininstration console, or you can again use asadmin:

  ./asadmin deploy target/call4all.war

 To undeploy the application, run:

  ./asadmin undeploy call4all
